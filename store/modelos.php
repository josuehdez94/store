...
<div class="jumbotron-fluid">
	<form method="POST" action="insertmo.php">
	<h3 class="text-center">Modelos</h3>
	<br>
	<div class="container col-4">
	<div class="form-group">
       <input type="text" name="modelo"  class="form-control"  placeholder="Ingresa un modelo" required>
    </div>
...
<div class="container">
  ...
  <thead>
	...
	<?php  
		...
		$resultsql=mysqli_query($enlace,$sql) or die('linea 75');
		while($row=mysqli_fetch_array($resultsql)){
			...
			echo'<tbody class="table-striped">
					<tr>
						...
						<td>'.$marca.'</td>
						<td>'.$status.'</td>
						<td><a href="deletemo.php?id='.$id.'"><button class="btn btn-success"><span class="spinner-border spinner-border-sm"></span>Borrar</button></a></td>
					</tr>';
		}
		echo'</table>
</div>';
